...
<title>Rent A Ride - Create Reservation Confirmation</title>
</head>
<body>
	...
	<div class=container>
		...
		<div class="content">
			...
			<p></p>		
  				A new Reservation was created by Id  ${reservationId}</br>
  				To return to Reservation List page click <a href="Reservation">here</a>

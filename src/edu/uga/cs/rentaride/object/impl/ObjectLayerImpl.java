...
import edu.uga.cs.rentaride.entity.impl.RentalLocaitonImpl;
...
public class ObjectLayerImpl implements ObjectLayer{
	...
	public Administrator createAdministrator( String firstName, String lastName, String userName, 
		...
		Administrator administrator = new AdministratorImpl(firstName, lastName, userName, emailAddress, 
				password, createDate, null, null);    	    			  
	...
	public Administrator createAdministrator(){
		...
		Administrator administrator = new AdministratorImpl(null, null, null, null, 
				null, null, null, null);    	    			  
		return administrator;
...
//		System.out.println("userName: " + userName + "/");
		Customer customer = new  CustomerImpl(firstName, lastName, userName, password, emailAddress, residenceAddress, UserStatus.ACTIVE, createDate, membershipExpiration, licenseState, licenseNumber, cardNumber, cardExpiration, 0);
		return customer;
	...
	public RentalLocation createRentalLocation( String name, String address, int capacity ){
		...
		RentalLocation rentalLocation = new RentalLocaitonImpl(name, address, capacity);
	...
	public RentalLocation createRentalLocation(){
		...
		RentalLocation rentalLocation = new RentalLocaitonImpl();
		return rentalLocation;
	...
	public Reservation createReservation( VehicleType vehicleType, RentalLocation rentalLocation, Customer customer,
		...
		Reservation reservation = new ReservationImpl(pickupTime, rentalDuration, customer, vehicleType, rentalLocation, null);
		return reservation;
	...
	public Rental createRental( Reservation reservation, Customer customer, Vehicle vehicle, Date pickupTime ) throws RARException{
		...
		Rental rental = new RentalImpl(pickupTime, null, 0, reservation, vehicle, customer);
		return rental;
	}
	...
	public VehicleType createVehicleType( String type ){
		...
		VehicleType vehicleType = new VehicleTypeImpl(type);
		return vehicleType;
	...
	public Vehicle createVehicle( VehicleType vehicleType, String make, String model,
		...
		Vehicle vehicle = new VehicleImpl(make, model, year, registrationTag, mileage, lastServiced, vehicleStatus, vehicleCondition, vehicleType, rentalLocation);
		return vehicle;
	...
	public Comment createComment( String comment, Rental rental, Customer customer ) throws RARException{
		...
		Date now = new Date();
		Comment commentModel = new CommentImpl(comment, now, customer, rental);
		return commentModel;
	...
	public Comment createComment(){
		...
		Comment commentModel = new CommentImpl();
		return commentModel;
	...
	public void deleteComment( Comment coment ) throws RARException{
		...
		persistence.deleteComment(coment);
	...
	public HourlyPrice createHourlyPrice( int minHrs, int maxHrs, int price, VehicleType vehicleType ) throws RARException{
		...
		HourlyPrice hourlyPrice = new HourlyPriceImpl(minHrs, maxHrs, price, vehicleType);
		return hourlyPrice;
	...
	public RentARideConfig findRentARideCfg() {
		RentARideConfig rentARideConfig = null;
		try {
			
			rentARideConfig = persistence.restoreRentARideConfig(); 
//			return rentARideConfig;
		} catch (RARException e) {
//			System.out.println("");
			e.printStackTrace();
		}
//		rentARideConfig = new RentARideConfigImpl();
		return rentARideConfig;

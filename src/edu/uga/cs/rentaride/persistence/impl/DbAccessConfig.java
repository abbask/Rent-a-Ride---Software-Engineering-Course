...
public abstract class DbAccessConfig
{
    ...
    /** The database name
     */
    static final String DB_NAME        = "team5";
    
    /** The database server name for the connection pool
     */
    static final String DB_SERVER_NAME = "http://uml.cs.uga.edu/3306";

    /** The JDBC connection string/URL.
     */
    static final String DB_CONNECTION_URL = "jdbc:mysql://uml.cs.uga.edu:3306/team5";

    /** The database user name.
     */
    static  String DB_CONNECTION_USERNAME = "team5";

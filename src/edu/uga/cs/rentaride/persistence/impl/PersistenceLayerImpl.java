...
public class PersistenceLayerImpl implements PersistenceLayer {
	...
	HourlyPriceManager hourlyPriceManager = null;
	CommentManager commentManager = null;
	RentARideConfigManager rentARideConfigManager = null;
	ReservationManager reservationManager = null;
	AdministratorManager administratorManager = null;
	CustomerManager customerManager = null;
	RentalLocationManager rentalLocationManager = null;
    ...
    // No need to have a delete Customer method, as a Customer will be removed by changing 
    // UserStatus
    /** 
...
//    	System.out.println(rentARideConfigManager);
...
//    	System.out.println(rentARideConfigManaer);
    	rentARideConfigManager.update(rentARideConfig);
    }
    ...
    public void storeCustomerReservation( Customer customer, Reservation reservation ) throws RARException{
    	...
    	if( customer == null )
            throw new RARException( "The Reservation's customer type is null" );
        if( !customer.isPersistent() )
            throw new RARException( "The Reservation's customer type is not persistent" );
    ...
    public Customer restoreCustomerReservation( Reservation reservation ) throws RARException{
    	...
    	return reservationManager.restoreCustomer(reservation);
    ...
    public void storeReservationRentalLocation( Reservation reservation, RentalLocation rentalLocation ) throws RARException{
    	...
    	if( rentalLocation == null )
            throw new RARException( "The Reservation's rental Location type is null" );
        if( !rentalLocation.isPersistent() )
            throw new RARException( "The Reservation's rental Location type is not persistent" );
    ...
    public RentalLocation restoreReservationRentalLocation( Reservation reservation ) throws RARException{
    	...
    	return reservationManager.restoreRentalLocation(reservation);
    ...
    public Iterator<Reservation> restoreReservationRentalLocation( RentalLocation rentalLocation ) throws RARException{
    	...
    	return rentalLocationManager.restoreHasLocation(rentalLocation);
    ...
    public void storeReservationVehicleType( Reservation reservation, VehicleType vehicleType ) throws RARException{
    	...
    	if( vehicleType == null )
            throw new RARException( "The Reservation's vehicle type is null" );
        if( !vehicleType.isPersistent() )
            throw new RARException( "The Reservation's vehicle type is not persistent" );
    ...
    public VehicleType restoreReservationVehicleType( Reservation reservation ) throws RARException{
    	...
    	return reservationManager.restoreVehicleType(reservation);
    ...
    public Iterator<Reservation> restoreReservationVehicleType( VehicleType vehicleType ) throws RARException{
    	...
    	return reservationManager.restoreReservationVehicleType(vehicleType);
    ...
    public void storeVehicleRentalLocation( Vehicle vehicle, RentalLocation rentalLocation ) throws RARException{
    	...
    	if (rentalLocation == null)
    		throw new RARException( "The Reservation's RentalLocation is null" );
        if( !rentalLocation.isPersistent() )
            throw new RARException( "The Reservation's RentalLocation is not persistent" );
    ...
    public RentalLocation restoreVehicleRentalLocation( Vehicle vehicle ) throws RARException{
    	...
    	return vehicleManager.restoreRentalLocation(vehicle);
    ...
    public Iterator<Vehicle> restoreVehicleRentalLocation( RentalLocation rentalLocation ) throws RARException{
    	return rentalLocationManager.restoreLocatedAt(rentalLocation);
    ...
    public void storeVehicleVehicleType( Vehicle vehicle, VehicleType vehicleType ) throws RARException{
    	...
    	if( vehicleType == null )
            throw new RARException( "The Vehicle's vehicleType is null" );
        if( !vehicleType.isPersistent() )
            throw new RARException( "The Vehicle's vehicleType is not persistent" );
    ...
    public VehicleType restoreVehicleVehicleType( Vehicle vehicle ) throws RARException{
    	...
    	return vehicleManager.restoreVehicleType(vehicle);
    ...
    public void storeVehicleTypeHourlyPrice( VehicleType vehicleType, HourlyPrice hourlyPrice ) throws RARException{
    	...
    	if( vehicleType == null )
            throw new RARException( "The hourly Price's vehicle type is null" );
        if( !vehicleType.isPersistent() )
            throw new RARException( "The hourly Price's vehicle type is not persistent" );
    ...
    public void storeRentalComment( Rental rental, Comment comment ) throws RARException{
    	...
    	if( rental == null )
            throw new RARException( "The comment's rental is null" );
        if( !rental.isPersistent() )
            throw new RARException( "The comment's rental is not persistent" );
    ...
    public Rental restoreRentalComment( Comment comment ) throws RARException{
    	...
    	return commentManager.restoreRental(comment);    	
    ...
    public Iterator<Comment> restoreRentalComment( Rental rental ) throws RARException{
    	...
    	return commentManager.restoreRentalComment(rental);    	
    ...
    public Customer restoreCustomerComment( Comment comment ) throws RARException{
    	...
    	return commentManager.restoreCustomer(comment);
    ...
    public Iterator<Comment> restoreCustomerComment( Customer customer ) throws RARException{
    	...
    	return commentManager.restoreCustomerComment(customer);
    ...
    public Customer restoreRentalCustomer( Rental rental ) throws RARException{
    	...
    	return rentalManager.restoreCustomer(rental);
    ...
    public Iterator<Rental> restoreRentalCustomer( Customer customer ) throws RARException{
    	...
    	return rentalManager.restoreRentalCustomer(customer);

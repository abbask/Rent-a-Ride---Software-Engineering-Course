 ...
 */
@WebServlet("/DeleteRentalLocation")  //DeleteRentalLocation
public class DeleteRentalLocation extends HttpServlet {
	private static final long serialVersionUID = 1L;


	static  String            templateDir = "WEB-INF/templates";
	static  String            templateName = "DeleteRentalLocation.ftl";
	static  String            resultTemplateName = "DeleteRentalLocationResult.ftl";
        ...
        try {
         ...
         //   rentalLocations = new LinkedList<List<Object>>();
            ...
            try {
               ...
               logicLayer.deleteRentalLocation(Id);
            } 
            catch ( Exception e ) {
                RARError.error( cfg, toClient, e );
                return;

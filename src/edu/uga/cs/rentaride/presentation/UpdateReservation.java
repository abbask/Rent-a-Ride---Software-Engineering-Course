...
public class UpdateReservation extends HttpServlet {
	...
	static  String            templateName = "UpdateReservation.ftl";
	static  String            resultTemplateName = "UpdateReservationConfirmation.ftl";
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			lstReservation = logicLayer.findReservation(Id, null, 0, 0, 0, 0, 0);

			for(Reservation r : lstReservation){
				root.put( "pickupTime", r.getPickupTime() );
				root.put("rentalDuration", r.getRentalDuration());
				root.put("rentalLocationId", r.getRentalLocation().getId());
				root.put("vehicleTypeId", r.getVehicleType().getId());
			}
